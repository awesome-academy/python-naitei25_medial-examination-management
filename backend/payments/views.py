...
class BillViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        try:
            bills = BillService().get_all_bills(int(page), int(size))
    ...
    def destroy(self, request, pk=None):
        try:
            ...
            return Response({"message": "Xóa hóa đơn thành công"}, status=status.HTTP_200_OK)
        except Http404:
            return Response({"error": "Không tìm thấy hóa đơn"}, status=status.HTTP_404_NOT_FOUND)
...
class TransactionViewSet(viewsets.ViewSet):
    ...
    def create_payment(self, request, bill_id=None):
        try:
            ...
            response = {"error": 0, "message": "success", "data": payment_url}
    ...
    def process_cash_payment(self, request, bill_id=None):
        try:
            ...
            response = {"error": 0, "message": "Thanh toán tiền mặt thành công", "data": None}
            return Response(response)
        except Exception as e:
            return Response({"error": -1, "message": str(e), "data": None}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def handle_payment_webhook(self, request):
        try:
            ...
            response = {"error": 0, "message": "Webhook delivered", "data": None}
            return Response(response)
        except Exception as e:
            return Response({"error": -1, "message": str(e), "data": None}, status=status.HTTP_400_BAD_REQUEST)

    # Fixed: Separate URL patterns for different actions
    ...
    def get_payment_info(self, request, order_id=None):
        try:
            ...
            response = {"error": 0, "message": "success", "data": payment_info}
            return Response(response)
        except Exception as e:
            return Response({"error": -1, "message": str(e), "data": None}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def cancel_payment(self, request, order_id=None):
        try:
            ...
            response = {"error": 0, "message": "success", "data": cancel_result}
            return Response(response)
        except Exception as e:
            return Response({"error": -1, "message": str(e), "data": None}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def handle_payment_success(self, request, order_id=None):
        try:
            ...
            response = {"error": 0, "message": "Thanh toán thành công", "status": "success", "order_id": order_id}
            return Response(response)
        except Exception as e:
    ...
    def handle_payment_cancel(self, request, order_id=None):
        try:
            ...
            response = {"error": 0, "message": "Đã hủy thanh toán", "status": "cancel", "order_id": order_id}
            return Response(response)
        except Exception as e:
            return Response({"error": -1, "message": str(e), "status": "error", "order_id": order_id}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def get_transactions_by_bill_id(self, request, bill_id=None):
        try:
            transactions = TransactionService().get_transactions_by_bill_id(bill_id)
            response = {"error": 0, "message": "success", "data": transactions}
            return Response(response)
        except Exception as e:
            return Response({"error": -1, "message": str(e), "data": None}, status=status.HTTP_400_BAD_REQUEST)
